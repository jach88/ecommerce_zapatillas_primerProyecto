...
import { obtenerProductos,crearProducto,editarProducto,subirArchivo,eliminarProducto } from '../services/productoService';
    ...
    let handleActualizar=(obj)=>{
      ...
      const manejarSubmitEdit = async (e) => {
        ...
        if(typeof imagen !== undefined){ //si es que es diferente de undefined hay imagen
          ...
          await editarProducto({...rProducto, imagen:urlArchivo,tallas:arr}, idp)
          getProductos();
      }else{
    ...
    let handleInput = (e) => {
      ...
      const manejarSubmit = async (e) => {
        ...
        try {
          ...
          const rpta = await crearProducto({ ...rProducto,imagen:urlArchivo,tallas:arr});//ya con la imagen obtenida lo agregamos al producto a Crear
          getProductos();
          await Swal.fire({
            icon: "success",
